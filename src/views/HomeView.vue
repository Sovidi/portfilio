...
export default {
  ...
  data() {
    return {
      ...
      workbox: [
        {id: 0, name: "Portfolio Vue.js", desc: "Vue.js로 제작된 보고계신 포트폴리오 페이지 입니다.", src: "./img/portfolio.gif", skills: "#Vue.js, #scss, #html, #MongoDB, #Express", href: "#", githref:"https://github.com/Sovidi/portfolio2" },
        {id: 1, name: "Portfolio Next.js", desc: "포트폴리오의 Next.js 이식버전입니다.", src: "./img/portfolio.gif", skills: "#Next.js, #scss, #html, #MongoDB, #Express", href: "https://portfolio3-blue.vercel.app/", githref:"https://github.com/Sovidi/portfolio3" },
